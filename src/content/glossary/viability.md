...
title: Viability
slug: viability
definition: "Viability denotes the ongoing maintenance of the organisational
  conditions that allow a system to continue existing as a coherent,
  constraint-closed biological agent. In APS, viability is not a static state
  but a dynamic, evaluative process: the system continuously regulates its
  activity relative to what preserves or undermines its persistence. Viability
  functions as the internal reference frame of biological agency, grounding
  normativity, function, and purposive organisation. Changes that sustain or
  restore constraint-closed organisation enhance viability, while those that
  disrupt or degrade it diminish viability. Viability is therefore
  activity-based, historically extended, and distributed across interacting
