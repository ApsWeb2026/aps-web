...
> **Where this concept fits:** Meaning is one of the central organisational consequences of viability-oriented semiosis within APS. It explains how differences acquire biological significance and thereby links evaluation, information, representation, agency, adaptation, and cognition within a unified explanatory framework. For the broader structure of APS, see *[APS Architecture Map — Navigating the Framework](/orientation/aps-architecture-map/)*.
