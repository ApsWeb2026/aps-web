...
TThis temporal extension is what APS describes as counterfactual depth. Activity may be stabilised across time, modulated by prior states, or structured in relation to anticipated or possible conditions. In all cases, cognition involves the organisation of evaluation beyond immediate coupling with the environment.
...
In this sense, cognition is not a universal feature of all life, but a developed mode of viability-oriented organisation that arises when evaluative activity becomes sufficiently structured, integrated, and temporally extended.
