...
definition: >
  ...
  and continuity of living systems across interacting timescales.
  Biological temporality is not merely the passage of time, but the
  structured organisation of viability-oriented processes through which
  living systems sustain, reorganise, and transform themselves across
  developmental, ecological, behavioural, and evolutionary durations.
inBrief: >
  In APS, temporality refers to the organised persistence and transformation
  of living systems across interacting timescales through which continuity,
  adaptation, development, and viable organisation are sustained across time.
relatedTerms:
  - continuity
  - persistence
  - process
