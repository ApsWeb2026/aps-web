...
title: Function
slug: function
definition: "Function in APS is the viability-relative organisational role
  through which viability-oriented, constraint-closed organisation is enacted.
  It applies to structures or processes within an already agentive system. A
  structure or process is functional only insofar as it contributes, in the
  present tense, to sustaining or restoring viability. Functional status is
  grounded in ongoing organisational contribution, not in selection history,
  ...
  while others undermine it. Purpose names the viability-oriented organisation
  of the system as a whole; function names the concrete operations through which
  that organisation is enacted."
inBrief: Function is how structures and processes contribute to sustaining a
