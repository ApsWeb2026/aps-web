...
definition: >
  ...
  and maintain the organisational conditions required for its own
  continued viability and persistence. Autonomous systems actively
  participate in sustaining themselves rather than depending entirely
  upon external systems for the maintenance of their organisation.
inBrief: >
  Autonomy is the capacity of a system to participate in maintaining the
  organisational conditions required for its own continued persistence.
  It does not imply independence from the environment, but active
  self-maintenance through viability-oriented organisation.
relatedTerms:
  - biological-agency
  - viability
