...
title: Affordance
slug: affordance
definition: A relational opportunity for action arising from the coupling of an
  organism and its environment. In APS, affordances are viability-relevant
  possibilities—features of the environment that can be functionally integrated
  into a system’s ongoing regulation. They are neither intrinsic properties of
  objects nor subjective perceptions, but dynamic relations whose significance
  depends on the system’s organisation and current state.
