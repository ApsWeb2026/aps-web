...
Persistence is organised relative to biological normativity. The activity of the system is modulated in relation to conditions that support or undermine its continued existence. These conditions are specified by viability, which provides the normative frame within which persistence is maintained.
...
Persistence is the ongoing activity through which a system maintains its organisation across time, while viability specifies the conditions under which this activity can be sustained.

## Key Point
Persistence is not mere survival but the continuous activity through which a system maintains its organisation across time.

## In brief
Persistence = the ongoing activity that maintains biological organisation.
