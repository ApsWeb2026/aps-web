...
definition: >
  ...
  capacities become externalised into material, symbolic, and environmental
  structures. In APS, technologies preserve, amplify, and extend capacities
  for communication, coordination, memory, cultural transmission, and
  collective action beyond the limits of individual organisms. Technology
  therefore functions as an environmentally distributed form of organised
  persistence operating across time and scale.

inBrief: >
  Technology externalises and extends organisational capacities through
  continuity-preserving structures embedded in the environment.
