...
definition: >
  ...
  regulates interactions, and supports organised persistence within social
  systems. In APS, social norms emerge when patterns of behaviour become
  sufficiently stable to guide coordinated activity among interacting
  organisms. Social norms extend biological normativity into the social
  domain by contributing to the continuity of social organisation across time.

inBrief: >
  A social norm is a coordination constraint that stabilises social
  organisation.
