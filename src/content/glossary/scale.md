...
**Physical scale belongs to the materially realised organisation. Scale, in the APS sense, is the analytic projection that asks which spatial and temporal extents, and which relations across them, are relevant to explaining how persistence is organised. It is not a hierarchy of biological levels or an independently existing dimension of Life.**
