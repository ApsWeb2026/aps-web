...
title: Coupling
slug: coupling
definition: In APS, coupling is the ongoing relational interaction through which
  a system and its environment mutually influence, constrain, and enable one
  another. It is the process by which external conditions become integrated into
  viability-oriented organisation and through which the system, in turn,
  modifies those conditions. Coupling is continuous, dynamic, and constitutive
  of both the system’s persistence and the structure of its effective
  environment.
inBrief: Coupling is the ongoing interaction through which organisms and
  environments co-constitute each other.
status: canonical
canonical: true
...
## Key Point  
  In APS, coupling is the constitutive process through which systems and environments are continuously co-produced within viability-oriented organisation.
