...
definition: >
  ...
  relations, or organisational dynamics required for viability-oriented
  persistence within a living system.

inBrief: >
  In APS, malfunction refers to continuity impairment within organised
  persistence. Malfunction is not merely the failure of an isolated component,
  but the disruption of organisational relations required for sustaining
  viable continuity across interacting biological processes and scales.
