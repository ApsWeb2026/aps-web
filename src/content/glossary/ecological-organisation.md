...
definition: >
  Ecological organisation refers to the structured relations through which
  organisms, populations, and environments mutually shape the conditions of
  biological persistence across time.
inBrief: >
  Ecological organisation concerns the organised relations between organisms
  and their environments that sustain biological persistence.
