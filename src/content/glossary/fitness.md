...
definition: >
  In APS, fitness is the historically situated capacity of viability-oriented,
  constraint-closed organisation to sustain persistence and lineage continuity
  under changing developmental and ecological conditions. Fitness reflects the
  relative continuity of organised persistence across generations rather than
  abstract optimisation or reproductive output alone.

inBrief: >
  Fitness is the context-dependent capacity of organised living systems to
  sustain persistence and continuity across generations.
