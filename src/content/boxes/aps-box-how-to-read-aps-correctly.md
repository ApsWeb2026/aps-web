...
- **Read concepts relationally, not in isolation**  
  Terms such as agency, process, scale, organisation, and normativity derive their meaning from their relations within the framework.
...
- **Interpret function and purpose internally**  
  Function and purpose refer to contributions to viability within the system, not to externally assigned roles or goals.
...
- **Expect concepts to constrain one another**  
  Definitions are interdependent; understanding one concept requires understanding how it fits within the system.

Reading APS is therefore not a matter of adopting new terminology, but of adopting a different way of organising biological explanation.
