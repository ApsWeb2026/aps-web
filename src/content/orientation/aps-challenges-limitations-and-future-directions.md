...
abstract: >
  APS provides an integrated explanatory framework centred on
  viability-oriented organised persistence. Like any developing
  theoretical framework, however, APS faces conceptual, empirical,
  and methodological challenges. This article examines those
  challenges, distinguishes genuine limitations from common
  misunderstandings, and outlines future directions for theoretical
  refinement, empirical application, and scientific development.
...
APS uses the term in a more fundamental sense. Biological agency refers to the capacity of a living system to regulate itself in ways that contribute to the maintenance of its own viability. Even simple organisms must continuously respond to changing conditions, repair damage, regulate internal processes, and maintain the organisational conditions required for continued existence. In this sense, agency refers not to conscious choice but to viability-oriented activity.
...
APS has already suggested that perturbation-based analysis may provide an important diagnostic strategy because biological organisation often becomes most visible when continuity is threatened. However, the systematic development of such approaches remains an ongoing task. If APS is to function as more than a conceptual framework, it must contribute to methods capable of identifying and analysing viability-oriented organisation in practice.
...
Nevertheless, further integration remains important. Future work should continue to clarify the relationship between viability-oriented organisation, evolutionary dynamics, developmental processes, and major evolutionary transitions. Such integration will help demonstrate how APS contributes to a broader understanding of biological continuity across both time scales and levels of organisation.
...
The future development of APS can be understood as a transition from conceptual integration to empirical application.

The first phase of the framework has focused on establishing foundational concepts and demonstrating how diverse biological phenomena can be interpreted through a common explanatory grammar centred on viability-oriented organised persistence. This work has produced a coherent conceptual architecture linking agency, normativity, development, cognition, evolution, ecology, and social organisation.

The next phase concerns operationalisation, comparative theoretical analysis, and empirical investigation. The task is no longer simply to describe the framework but to explore how it can guide biological inquiry.

Whether APS ultimately succeeds will depend on the productivity of this transition. Its central concepts must prove capable of generating useful explanations, productive research questions, and empirically meaningful analyses. Like all scientific frameworks, APS remains open to revision, refinement, and criticism. Its future will be determined not by conceptual ambition alone but by its capacity to illuminate the living world.

## Conclusion

APS should not be viewed as a finished doctrine or a closed system of thought. It is a developing explanatory framework that seeks to understand life through the organisation required for viability-oriented persistence.

The framework has already established an integrated conceptual foundation connecting many traditionally separate areas of biology. Yet important challenges remain. Concepts must be clarified, operational methods developed, theoretical relationships refined, and empirical applications expanded.

These challenges do not diminish the significance of the framework. On the contrary, they define the next stage of its development. The future of APS lies not in defending a completed theory, but in participating in the ongoing scientific effort to understand how living systems persist, adapt, and organise themselves across time.