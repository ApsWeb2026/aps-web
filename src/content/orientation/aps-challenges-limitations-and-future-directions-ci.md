...
abstract: >
  ...
  research programme, APS faces conceptual, empirical,
  methodological, and philosophical challenges. This article
  examines those challenges, distinguishes genuine limitations
  from common misunderstandings, and outlines future directions
  for theoretical refinement, explanatory development,
  operationalisation, comparative evaluation, and empirical
  application.

keyPoints:
  - APS is a developing research programme rather than a completed theory.
  - Clarifying biological agency remains an important explanatory task.
  - Organised persistence requires further operationalisation and empirical investigation.
  - APS must demonstrate explanatory value through comparative biological case studies.
  - Organisational transition and novelty represent major areas for future theoretical development.
  - Architectural Dependency provides a framework for understanding organisational preconditions and explanatory pathways.
  - APS explains cross-scale influence through materially implemented constraints rather than strong top-down causation.
  - Future development requires continued philosophical, methodological, and empirical refinement.
...
Like any developing framework, however, APS faces unresolved questions and areas requiring further development. Some of these arise from misunderstandings of the framework, while others represent genuine challenges that must be addressed if APS is to mature into a broader scientific research programme.
...
<p class="diagram-caption">
  ...
  comparative evaluation, explanatory refinement, and the construction of
  a broader biological research programme.
</p>
