...
slug: mentalistic-language-biology
abstract: Biological research frequently employs terms such as agency,
  cognition, decision-making, and purpose, even in contexts far removed from
  human psychology. These usages are often criticised as anthropomorphic or
  metaphorical. The Agency–Process–Scale (APS) framework shows that such
  language persists because it tracks real organisational features of living
  systems. By grounding these terms in viability-oriented, constraint-closed
  organisation, APS clarifies their meaning, separates them from assumptions
  about consciousness, and provides explicit criteria for their appropriate use
  across the full range of life.
status: canonical
canonical: true
...
keyPoints:
  - "•\tMentalistic terms in biology persist because they describe real
    organisational features of living systems, not hidden psychological states.
    "
  - •	APS grounds these terms in viability-oriented, constraint-closed
    organisation rather than consciousness or subjective experience
  - "•\tAgency is the defining activity of life, while cognition and
    intelligence are derived organisational capacities. "
  - "•\tConsciousness and sentience are not required for agency or cognition and
...
More precisely, APS begins with **viability-oriented, constraint-closed organisation** — the condition under which a system maintains and regenerates the constraints that sustain its own persistence.
...
APS therefore treats **agency**, **cognition**, **purpose**, and **value** not as mental properties, but as ways of describing how viability-oriented systems are organised in time.
...
A property is something a system can possess or lack while remaining the same kind of thing. Agency does not fit this pattern. Remove viability-oriented organisation and you do not get an organism without agency—you get a dead system.
...
Treating agency as a property leads to predictable errors:

- inferring agency from behaviour alone  
- grading it by appearance  
- attributing it metaphorically to non-living systems  

Treating agency as organised activity leads to a different approach:
...
APS clarifies commonly used terms by grounding them in organisation rather than psychology:
...
- **Sentience / Consciousness** — Not required for agency or cognition; open empirical questions  
...
By grounding mentalistic terms in organisation rather than psychology, APS:
