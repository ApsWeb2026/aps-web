...
abstract: >
  ...
  shared traits or fixed essences. This article explains how taxa emerge as
  processual patterns, why boundaries are often graded, and how classification
  remains scientifically rigorous without relying on essentialist assumptions.
keyPoints:
  - Classification in APS tracks organised persistence rather than shared traits alone.
  - Taxa are processual patterns of viability-oriented organisation, not static groups.
  - Traits, genes, and phylogenies are evidential, not defining, of taxa.
  - Biological boundaries are often graded due to continuous, multi-scale processes.
  - APS preserves the utility of taxonomy while rejecting essentialism.
...
A taxon is therefore not a set of organisms defined by traits, but a **recognised continuity of viability-oriented, constraint-closed organisation**. Classification identifies and stabilises these continuities for the purposes of explanation and communication.
...
- Necessary but not sufficient for defining taxa  
...
Under APS, taxa are best understood as **relatively stable regions within the continuous transformation of life**.
...
By identifying taxa as patterns of persistent organisation, classification helps to:
...
## Key Point
APS reframes biological classification as the **mapping of persistent, viability-oriented organisation**, where taxa are recognised as processual patterns rather than static categories defined by essential traits.