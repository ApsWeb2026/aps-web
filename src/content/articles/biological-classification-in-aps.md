...
keyPoints:
  - Classification does not partition life into fixed units but describes patterns of organised persistence.
  - Taxa are analytical constructs that stabilise recurring organisational patterns across evolutionary time.
  - Biological organisation is continuous and processual, not discretely layered.
  - Species and higher taxa reflect modes of persistence, transformation, and inheritance.
  - APS replaces static categorisation with scale-sensitive, processual interpretation.
...
A taxon therefore does not mark a fixed boundary in nature. It marks a region of relative organisational coherence.
...
Taxa are therefore analytical constructs rather than ontological primitives.
...
But they do not define what exists. They describe how organisation persists and transforms.
...
Classification in APS does not divide life into fixed categories; it describes recurring patterns of viability-oriented organisation across scale and evolutionary time.