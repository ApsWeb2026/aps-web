...
cluster: foundations
keyPoints:
  - APS presents the Agency–Process–Scale framework as a unified account of
    life, persistence, and evolution.
  - The site is organised as an interconnected conceptual system rather than a
    collection of isolated essays.
  - The APS Glossary provides definitions of the core concepts used throughout
    the framework.
  - New readers should begin with the orientation articles listed below.
