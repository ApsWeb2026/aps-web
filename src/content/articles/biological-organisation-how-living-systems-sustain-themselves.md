...
abstract: >
  ...
  temporally organised coordination of processes, constraints, and relations
  through which systems preserve viable continuity across continual
  transformation. It shows how biological organisation depends upon temporal
  organisation, constraint closure, developmental reconstruction, and
  organism–environment coupling, while grounding biological normativity and
  enabling biological agency through the active modulation of organisational
  relations. Within APS, biological organisation is understood as
  viability-oriented, continuity-producing, constraint-closed organisation
  enacted through ongoing processes across interacting scales.

keyPoints:
  - Biological organisation is not static structure but the ongoing coordination of relations that sustain organised persistence across time.
  - Living systems preserve continuity through continual reconstruction rather than rigid stability.
  ...
  - Temporal organisation coordinates processes and constraints into continuity-producing organisation.
  - Normativity arises because some organisational states support persistence while others undermine it.
  - Biological organisation is processual, developmental, ecological, and multiscale.
