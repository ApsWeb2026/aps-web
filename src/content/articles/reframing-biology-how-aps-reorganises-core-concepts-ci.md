...
abstract: >
  APS does not replace biology's central concepts. It reorganises them.
  By treating life as viability-oriented, constraint-closed organisation
  and agency as the activity through which that organisation is enacted,
  APS provides an explanatory grammar that integrates life, function,
  evolution, development, ecology, cognition, and biological explanation
  within a common framework of organised persistence. This article
  explains how that reorganisation reshapes biology's conceptual
  architecture while preserving the empirical achievements of modern
  biological science.
...
references:
  ...
  - id: dupre-nicholson-2018-manifesto
    ...
    book: "Everything Flows: Towards a Processual Philosophy of Biology"
    pages: "3–46"
    publisher: Oxford University Press
...
The cognitive architecture developed here illustrates the wider explanatory strategy of APS. APS represents proposed relationships among Life, Agency, Biological Evaluation, Significance, Integration, Cognition, Mind, Selfhood, Reflective Agency, and Meaning through a pathway architecture. Architectural Dependency treats each connection as a dependency hypothesis whose relation must be specified rather than inferred from its position in the sequence. The pathway therefore provides an organised representation of APS commitments without establishing that every connection is causal, chronological, necessary, or uniformly organisational.
...
Architectural Dependency clarifies how the connections represented within this explanatory grammar should be interpreted. Concepts are related through explicitly proposed dependency hypotheses rather than because they occupy a hierarchy or because one must be assumed to cause another. Different connections may express constitutive, enabling, causal, constraint-based, historical, conceptual, or mixed relations. Their position within the APS architecture therefore makes the framework's commitments visible without establishing those commitments by conceptual arrangement alone.
...
From this foundation, APS relates many of its major concepts through an explicit pathway architecture. Agency concerns the activity through which life is enacted; organised persistence concerns continuity despite continual change; and APS interprets function, purpose, and normativity in relation to viability-oriented organisation. Development, evolution, and ecology address different explanatory questions concerning living organisation and its persistence. Biological Evaluation, Significance, Integration, Cognition, Mind, Selfhood, Reflective Agency, and Meaning are connected within APS through proposed dependency relationships whose particular form and evidential standing must be assessed separately.
