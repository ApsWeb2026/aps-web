---
title: "Comparative Explanatory Methodology in Theoretical Biology"
slug: comparative-explanatory-methodology-theoretical-biology
date: 2026-08-07
type: article
status: canonical
canonical: true
...
abstract: >
  Comparative Explanatory Methodology in Theoretical Biology establishes a
  general methodology for comparing organisational research programmes in
  contemporary theoretical biology. Rather than adjudicating between competing
  theories, the article develops a comparative explanatory framework that
  examines the explanatory priorities, organising principles, target phenomena,
  and domains of application of major organisational approaches. The article
  provides the methodological foundation for the APS Comparative Theories
  programme.

keyPoints:
  - Comparative explanatory methodology compares explanatory priorities rather than competing truth claims.
  - Organisational research programmes are compared according to their explanatory architecture.
  - The methodology distinguishes explanatory targets, organising principles, explanatory strengths, and domains of application.
  - Comparative methodology complements rather than replaces existing theoretical biology.
  - The methodology provides the constitutional framework for the APS Comparative Theories programme.
...
references:
  ...
  - mitchell-2003-biological-complexity
  - kellert-longino-waters-2006-scientific-pluralism
  - mantzavinos-2016-explanatory-pluralism
  - laudan-1977-progress-problems
  - kitcher-1993-advancement-science
  - brigandt-2013-explanation-biology
  - baedke-2025-organism
  - nicholson-2014-return-organism
  - nicholson-2019-cell-machine
  - dupre-nicholson-2018-manifesto
  - nicholson-dupre-2018-everything-flows
  - bouchard-huneman-2013-groups-individuals
  ...
  - bechtel-richardson-1993-discovering-complexity
...
The emergence of multiple organisational research programmes is itself a sign of intellectual progress. Rather than indicating theoretical fragmentation, it reflects increasing attention to questions concerning the organisation of living systems that were previously addressed only indirectly. As organisational approaches have matured, the need has shifted from demonstrating their legitimacy to understanding how their explanatory contributions relate to one another.

This situation reveals a broader methodological gap. Contemporary theoretical biology possesses numerous organisational research programmes, yet relatively little explicit methodology for comparing them as explanatory frameworks. Existing discussions commonly evaluate individual theories on their own terms or contrast particular concepts such as agency, information, autonomy, or meaning. Far less attention has been given to developing a general methodology capable of asking a more fundamental set of questions. What phenomenon does a programme principally seek to explain? Which organising principle occupies the centre of its explanatory architecture? How are concepts such as organisation, agency, function, information, cognition, or meaning related within that framework? Where are its principal explanatory strengths, and what kinds of biological questions does it illuminate most effectively? Without an explicit comparative methodology, answers to these questions remain fragmented, making it difficult to distinguish genuine theoretical disagreement from differences in explanatory purpose or organisation.

The present article addresses this methodological need by developing a comparative explanatory methodology for organisational research programmes in theoretical biology. Rather than asking which framework is correct, the methodology asks what each framework is organised to explain and how its explanatory architecture contributes to understanding living systems. Comparison therefore focuses on explanatory priorities rather than competitive truth claims. The objective is not to reduce different programmes to a common vocabulary, nor to synthesise them into a single theory, but to provide a principled basis for understanding both their shared concerns and their distinctive explanatory contributions.

The comparative methodology developed here arises from the Agency–Process–Scale (APS) research programme, but its purpose is methodological rather than advocative. APS provides the conceptual basis from which the comparative framework has been developed, yet the methodology is intended to be applicable to organisational research programmes generally. In this respect, APS functions as the source of the comparative methodology rather than as the conclusion toward which the comparison is directed. The article therefore seeks to contribute not only to the development of APS itself but also to broader discussions concerning biological explanation, theoretical integration, and the organisation of explanatory knowledge within contemporary biology.
...
The increasing prominence of organisational research programmes represents one of the most significant developments in contemporary theoretical biology. Over recent decades, a wide range of approaches has sought to explain living systems by placing organisation at the centre of biological explanation. Although these programmes differ in their theoretical commitments, they share the conviction that living systems cannot be adequately understood solely through descriptions of mechanisms, molecular interactions, or informational processes. Instead, they investigate the organisation through which living systems maintain themselves, regulate their activities, interact with their environments, and generate biologically significant relations.

This common orientation reflects an important shift within theoretical biology. Earlier debates often centred on whether biological phenomena could ultimately be reduced to physical and chemical processes. Contemporary organisational approaches generally accept the necessity of mechanistic explanation while arguing that mechanisms alone do not fully explain the distinctive organisation of living systems. Increasing attention has therefore been directed towards questions concerning autonomy, agency, organisation, meaning, information, communication, cognition, development, and persistence. The growth of organisational research programmes should be understood as an expression of this expanding explanatory landscape rather than as evidence of theoretical fragmentation.

The emergence of multiple organisational programmes is itself a sign of intellectual progress. As understanding of living systems has become more sophisticated, different research traditions have developed distinctive ways of investigating questions that were previously treated only indirectly. The resulting plurality does not indicate conceptual disorder. Rather, it reflects the recognition that biological organisation can be approached from different explanatory perspectives, each illuminating aspects of living systems that may remain less visible within alternative frameworks. The methodological challenge therefore arises not because plurality exists, but because scientific understanding increasingly depends upon recognising how these different explanatory perspectives relate to one another.
...
Recognising this distinction has important methodological consequences. Comparisons between research programmes often proceed by asking which theory offers the better explanation of a particular biological phenomenon or by contrasting individual concepts such as agency, information, autonomy, or meaning. Although such comparisons may be valuable, they frequently overlook a more fundamental question. Meaningful evaluation presupposes meaningful comparison. Before competing explanations can be assessed, it is first necessary to understand what each research programme is organised to explain and how its explanatory architecture has been constructed. Apparent disagreements may arise not because programmes offer incompatible accounts of the same explanatory problem, but because they assign different explanatory priorities within their respective conceptual architectures.

The task of comparison is therefore more demanding than evaluating isolated concepts or contrasting theoretical conclusions. Organisational research programmes are comprehensive explanatory frameworks whose concepts derive much of their significance from their relationships to one another. Agency, organisation, meaning, information, communication, cognition, function, and persistence do not occupy identical explanatory roles across different programmes. Understanding these relationships requires comparison at the level of explanatory architecture rather than at the level of individual concepts. It also requires explicit criteria through which different organisational frameworks may be examined without presupposing that they are attempting to answer identical scientific questions.
...
[[box:why-compare-organisational-research-programs]]
...
A further consequence follows from this approach. Because the methodology compares explanatory organisation rather than theoretical conclusions, it remains neutral with respect to the research programmes under consideration. It does not determine which framework is ultimately correct, nor does it assume that all programmes should converge upon a single explanatory principle. Instead, it recognises that different organisational research programmes may legitimately illuminate different aspects of living systems. The purpose of comparison is therefore clarification rather than adjudication. By identifying the explanatory priorities that organise different research programmes, the methodology enables both their common concerns and their distinctive contributions to become more clearly visible.

The comparative methodology presented here has been developed within the Agency–Process–Scale (APS) research programme. APS therefore provides the conceptual origin of the methodology, but not its predetermined outcome. The methodology is intended to be applicable to organisational research programmes generally, irrespective of their particular theoretical commitments. In this respect, APS contributes a methodology for biological explanation rather than an evaluative framework that predetermines the results of comparison. This distinction is fundamental to the present article. The methodology seeks to establish common grounds for systematic comparison while allowing each research programme to be understood on its own explanatory terms.
...
[[box:comparative-analytical-protocol]]
...
The third analytical question concerns explanatory priorities. Every explanatory architecture assigns greater importance to particular biological questions than to others. These priorities determine which phenomena are treated as fundamental, which concepts become explanatorily central, and which forms of biological organisation receive greatest analytical attention. Explanatory priorities therefore distinguish research programmes even when they investigate many of the same biological systems. Comparison at this level seeks to clarify the organisational logic through which explanatory attention is distributed rather than to evaluate the correctness of competing explanations.
...
<p class="diagram-caption">
  <em>
    ...
    distinctive explanatory architectures. The comparison is illustrative
...
The analytical protocol, however, reveals a different pattern. Although the programmes investigate overlapping biological phenomena, they organise explanation around different explanatory priorities. Biosemiotics gives explanatory priority to semiosis and the generation of biological significance. Enactivism places explanatory priority upon embodied sense-making and organism–environment interaction. APS gives explanatory priority to viability-oriented organised persistence as the organisational condition that renders biological phenomena intelligible. These differences do not necessarily represent incompatible theories. Rather, they identify different explanatory centres around which broader conceptual architectures have been organised.
...
The comparative analytical protocol developed in this article is intended to apply equally to all organisational research programmes, including the Agency–Process–Scale (APS) framework from which it has emerged. APS is therefore not exempt from the methodology that it proposes. Like every other organisational research programme, it possesses a primary explanatory target, an organising principle, a characteristic explanatory architecture, distinctive explanatory priorities, recognised domains of application, and an identifiable explanatory scope. Subjecting APS itself to the comparative protocol reinforces the neutrality of the methodology by demonstrating that the same analytical standards apply consistently across all organisational frameworks.

Viewed in this way, APS may first be understood as an organisational research programme centred upon viability-oriented organised persistence. Its primary explanatory target is the organisation through which living systems maintain and re-establish the conditions of their continued persistence. Agency, process, and scale do not constitute independent explanatory entities but complementary analytical perspectives through which that organisation may be investigated. APS therefore organises biological explanation around the conditions required for living systems to remain viable through continual change, and it interprets biological concepts according to their contribution to that enduring organisational phenomenon.

When examined through the comparative protocol established in this article, however, APS exhibits a second characteristic that distinguishes it from the organisational research programmes considered previously. In addition to proposing a particular explanatory architecture, APS has generated a methodology for comparing explanatory architectures themselves. The comparative analytical protocol is therefore not presented as an external evaluative framework imposed upon theoretical biology. Rather, it has emerged from sustained reflection upon the organisation of biological explanation within the APS research programme and has subsequently been generalised into a methodology applicable to organisational research programmes more broadly.

This distinction is important because it clarifies the dual contribution made by APS. As a research programme, APS advances an explanatory account of living organisation centred upon viability-oriented organised persistence. As a methodological framework, it provides a systematic procedure for comparing how different organisational research programmes structure biological explanation. These contributions are related but not identical. Acceptance of the comparative methodology does not require acceptance of APS as a biological framework, just as the usefulness of the methodology does not depend upon prior agreement with every theoretical commitment of the APS programme. The methodology therefore remains available as a general analytical instrument for theoretical biology irrespective of the reader's position concerning APS itself.
...
A further implication concerns scholarly communication within theoretical biology. A shared comparative methodology provides a common analytical language through which organisational research programmes may be examined without requiring conceptual uniformity or theoretical consensus. Rather than eliminating disagreement, the methodology clarifies the explanatory questions being addressed, the organising principles employed, and the relationships between different explanatory architectures. In doing so, it creates conditions for more precise and constructive dialogue across theoretical traditions.

The methodology also establishes a practical foundation for future comparative research. Because the comparative analytical protocol specifies a reproducible sequence of analytical questions, it may be applied consistently across diverse organisational research programmes while preserving the conceptual integrity of each. The Comparative Theories programme developed within APS adopts this protocol as its common methodological foundation, enabling detailed comparative studies to proceed within a shared analytical framework rather than as independent theoretical reviews.

The present article has argued that organisational research programmes should be compared through their explanatory architectures rather than through isolated concepts or claims of theoretical superiority. It has proposed that explanatory architectures become intelligible when analysed according to their explanatory targets, organising principles, explanatory priorities, conceptual organisation, domains of application, and explanatory scope. In doing so, it contributes four closely related methodological advances: the identification of explanatory architecture as the appropriate unit of comparison, explanatory organisation as the basis of comparison, a comparative analytical protocol as a reproducible methodological instrument, and clarification before adjudication as the governing purpose of comparative analysis.

These contributions establish a coherent methodological foundation for comparative investigation within theoretical biology. Their significance, however, extends beyond the immediate methodology developed here. The broader implications of viewing explanatory architectures as legitimate objects of scientific investigation suggest a wider perspective on the organisation of biological explanation itself. That broader perspective forms the subject of the final section.

## Toward a Comparative Explanatory Architecture of Theoretical Biology
...
From this perspective, explanatory architectures become part of the subject matter of theoretical biology rather than merely the background against which biological theories are developed. Questions concerning explanatory organisation, explanatory priorities, organising principles, and conceptual integration are no longer treated as incidental features of individual research programmes. They become explicit objects of comparative analysis. Such investigation complements empirical biology by examining not only what biological theories explain, but also how biological explanation itself is organised.

This shift carries important methodological consequences. Organisational research programmes need no longer be viewed primarily as competing schools of thought seeking exclusive explanatory authority. They may instead be understood as distinctive explanatory architectures that illuminate different aspects of living systems through different organising principles and explanatory priorities. Comparative analysis therefore seeks to understand relationships among explanatory frameworks before asking whether they should be integrated, revised, or challenged. In this way, methodological clarification becomes a precondition for more precise theoretical evaluation rather than its consequence.
