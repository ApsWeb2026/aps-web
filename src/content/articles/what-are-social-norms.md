...
<div class="aps-diagram">
  <a href="/assets/diagrams/values-to-morality-pathway.png" target="_blank" rel="noopener">
    <img
      src="/assets/diagrams/values-to-morality-pathway.png"
      alt="From Values to Morality"
      loading="lazy"
    />
  </a>

  <p class="aps-diagram-caption">
    <strong>From Values to Morality.</strong>
    Shared values become organised through collective evaluation, generating social norms that structure expectations within a community. These norms provide the foundation from which moral evaluation and morality later emerge.
  </p>
</div>
