---
date: 2026-07-28
title: Why APS? Why Biology Still Needs an Organisational Framework for Life
slug: why-aps
type: orientation
status: canonical
canonical: true
...
abstract: >
  ...
  ecology, and systems biology. Yet this success has also sharpened enduring
  questions concerning the nature of life, biological organisation, and the
  explanatory target of biology itself. Rather than proposing a new biological
  theory, the Agency–Process–Scale (APS) framework addresses these questions by
...
references:
  - id: aristotle-de-anima
    authors: Aristotle
    year: 1961
    originalYear: c.350 BCE
    title: "De Anima (On the Soul)"
    editors: Ross, W. D.
    publisher: Clarendon Press

  - id: bernard-1865-experimental-medicine
    authors: Bernard, C.
    year: 1865
  ...
  - id: kauffman-1993-origins-of-order
  ...
  - id: ganti-2003-principles-of-life
    authors: Gánti, T.
    year: 2003
  ...
  - id: nicholson-2019-life-as-process
  ...
  - id: dupre-2012-processes-of-life
    authors: Dupré, J.
    year: 2012
    title: "Processes of Life"
    publisher: Oxford University Press
    publicationType: book
    verification:
      authority: Oxford University Press

  - id: godfrey-smith-2014-philosophy-of-biology
  ...
  - id: mitchell-2009-unsimple-truth
...
This orientation also explains why APS is organised around three complementary analytical projections: **Agency**, **Process**, and **Scale**. These are neither separate components of reality nor independent causal forces. They are complementary analytical perspectives on one and the same living organisation.
