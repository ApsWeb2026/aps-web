...
abstract: >
  This article explains purpose in APS as the organisation of activity
  relative to viability-oriented organised persistence. Biological
  purposiveness does not require external design, conscious intention,
  representation, or mystical teleology. Instead, purpose emerges from the
  continuity-preserving organisation of living systems that actively regulate
  the conditions of their own persistence across changing conditions. APS
  naturalises purposiveness through organised persistence, continuity
  regulation, biological agency, endogenous normativity, and dynamically
  maintained organism–environment organisation.

keyPoints:
  - Purpose in APS is the organisation of activity relative to viability-oriented persistence.
  - Biological purposiveness does not require representation, foresight, or external design.
  - Purpose organises continuity-preserving biological activity.
  - Function operationalises purposive organisation within living systems.
  - Mechanisms realise purposive organisation without explaining purposiveness independently.
  - Normativity emerges because continuity-preserving organisation can succeed or fail.
  - Teleonomy reflects real organisational orientation within living systems.
...
Agency,
purpose,
and normativity therefore describe analytically distinct but organisationally integrated aspects of continuity-preserving biological organisation.
...
or developmental process becomes functional because it contributes to the viability-oriented continuity around which the larger system is organised.
...
and behavioural organisation all involve organised mechanistic relations.
...
and ecological signals become meaningful because they influence continuity conditions.
