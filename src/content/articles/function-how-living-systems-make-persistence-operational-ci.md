...
abstract: >
  Biological functions are commonly understood as the contributions made by
  particular structures or mechanisms to the operation of living systems.
  While such analyses explain how individual functions are realised, they do
  not by themselves explain how living systems continually maintain
  themselves despite ongoing material turnover, developmental change,
  physiological reorganisation, and environmental variation. This article
  argues that biological function is most fully understood as operational
  organisation. Functions are interpreted as viability-oriented
  organisational roles whose significance derives from their integration
  within the continuing activity of the organism. The article develops an
  operational architecture encompassing temporal organisation, functional
  integration, mechanistic realisation, constraint modulation, functional
  equivalence, adaptive reorganisation, distributed functional organisation,
  and operational persistence. Together these organisational dimensions
  explain how living systems continually maintain and re-establish the
  conditions of their own persistence. In doing so, the article complements normative accounts of biological function by providing an integrated account of how biological functions collectively realise the continuing activity of life.

keyPoints:
  - Biological functions are organised into the continuing activity through which living systems maintain viability.
  - The biological significance of functions derives from their integration within the organisation of living systems.
  - Functional organisation is realised through the coordinated activity of materially implemented mechanisms.
  - Constraint modulation continually maintains and re-establishes the organisational conditions required for viability.
  - Functional equivalence enables organisational roles to be preserved despite changes in their mechanistic realisation.
  - Adaptive reorganisation allows living systems to maintain viability under changing internal and environmental conditions.
  - Organism–environment relations are integral to operational organisation while biological agency remains centred in the organism.
  - Operational persistence is realised through the coordinated organisation of viability-oriented functional activity.
...
<div class="aps-diagram">
  ...
  <p class="aps-diagram-caption">
    <strong>Function and Endogenous Normativity.</strong>
    Functional organisation emerges through viability-oriented organised persistence in which evaluation and regulation distinguish continuity-supporting from continuity-disrupting conditions.
  </p>
</div>
...
<div class="aps-diagram">
  ...
  <p class="aps-diagram-caption">
    ...
    Mechanisms realise functional organisation within systems organised around viability-oriented continuity and organised persistence.
  </p>
</div>
