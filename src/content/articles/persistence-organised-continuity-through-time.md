...
abstract: >
  Persistence is one of the central organising concepts in APS. Living systems
  do not persist by remaining unchanged, but by maintaining organised
  continuity across ongoing transformation. This article explains persistence
  as the active continuity of viability-oriented organisation through time. It
  shows how persistence depends upon temporal organisation, constraint
  closure, regulation, and adaptive reorganisation, while grounding
  biological identity, normativity, agency, resilience, and evolutionary
  continuity. Within APS, persistence is understood not as static endurance
  but as organised continuity enacted across processes and scales.

keyPoints:
  - Persistence in living systems is organised continuity across transformation, not static endurance.
  - Biological persistence depends upon temporal organisation and viability-oriented activity.
  - Living systems persist through ongoing turnover, regulation, repair, and adaptation.
...
Development reorganises structure.
...
- and maintain organisational coherence across time
...
Living systems actively sustain the conditions required for their own continued existence.
...
It is continuity of organised persistence.
...
Agency therefore functions as continuity-preserving activity organised relative to viability.
...
In development:
- persistence concerns continuity across transformation of organisational states.
