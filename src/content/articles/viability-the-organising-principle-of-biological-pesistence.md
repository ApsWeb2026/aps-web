...
role: core
abstract: >
  Viability is one of the central organising principles of APS. Living systems
  do not merely survive — they actively sustain, reconstruct, and regulate the
  conditions required for continued persistence across changing conditions.
  This article explains viability as the continuity-producing orientation of
  biological organisation. It shows how viability grounds biological
  normativity, enables agency, structures persistence, and integrates
  organisation across process, scale, development, and temporality. Within APS,
  viability is understood not as passive survival or static maintenance, but
  as the organised capacity to preserve continuity through continual
  transformation.
keyPoints:
