---
date: 2026-09-05
title: "How Should a New Scientific Framework Be Tested?"
slug: how-should-a-new-scientific-framework-be-tested
type: article
status: canonical
canonical: true
...
abstract: >
  A new scientific framework should receive its strongest fair test while
  remaining genuinely exposed to evidential limitation. Framework assessment
  therefore requires separating different kinds of claim, matching evidential
  burdens to those claims, using strong relevant alternatives where comparison
  is warranted, permitting adverse and null outcomes, testing transfer where
  broader scope is claimed, and keeping local results and subsequent framework
  revisions appropriately bounded. Scientific standing may consequently be
  differentiated across a framework rather than reduced to global endorsement
  or rejection.

keyPoints:
  - "A scientific framework should be tested through the distinct claims for which scientific standing is sought, not treated as a single proposition that simply passes or fails."
  - "Different conceptual, methodological, explanatory, modelling, empirical and scope claims may carry different evidential burdens."
  - "A fair test gives the framework its strongest defensible formulation while preserving genuine possibilities of adverse, null, unresolved or comparator-favourable outcomes."
  - "Local explanatory success does not establish framework-wide superiority, and local failure does not establish framework-wide rejection."
  - "Broader claims require evidence commensurate with their scope, and material framework revisions after testing must remain visible."
...
references:
  ...
  - lipton-2004-inference-best-explanation
  ...
  - oreskes-shrader-frechette-belitz-1994-verification-validation-confirmation
  - munafo-et-al-2017-manifesto-reproducible-science
  - yarkoni-2022-generalizability-crisis
---

**Where This Article Fits**

*The preceding article, [A Practical Guide to Building Better Scientific Explanations](/articles/a-practical-guide-to-building-better-scientific-explanations/), showed how an individual explanation can be constructed and assessed so that its explanandum, evidence, comparator, claimed contribution and scope remain appropriately aligned.*
...
*Earlier articles established the controls that PA-10 now inherits. [How Should Scientific Explanations Be Compared?](/articles/how-should-scientific-explanations-be-compared/) required sufficiently matched explanatory targets and strong relevant alternatives. [What Counts as Explanatory Gain?](/articles/what-counts-as-explanatory-gain/) established that gain is bounded, target-relative and comparator-relative. [Which Explanatory Framework Is Best?](/articles/which-explanatory-framework-is-best/) showed that controlled comparison need not produce a global winner.*
...
<a href="/assets/diagrams/methodology-testing-framework.png" target="_blank" rel="noopener">
  <img
    src="/assets/diagrams/methodology-testing-framework.png"
...
See the glossary entries for [Biological Explanation](/glossary/biological-explanation/), [Explanation](/glossary/explanation/), [Explanandum](/glossary/explanandum/) and [Explanatory Target](/glossary/explanatory-target/).