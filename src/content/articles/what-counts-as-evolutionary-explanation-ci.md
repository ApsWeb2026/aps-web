...
abstract: >
  ...
  the Agency–Process–Scale (APS) framework. APS argues that evolutionary
  explanation is directed not merely at statistical change or differential
  reproductive success, but at the transformation of viability-oriented,
  persistence-sustaining organisation across generations. Evolutionary
  explanation therefore requires attention to persistence, adaptation,
  inheritance, development, variation, ecological interaction, and multiscale
  organisation. Natural selection remains a major evolutionary process, but it
  operates within broader organisational conditions that evolutionary
  explanation must also capture.
...
<div class="aps-diagram">
  <a href="/assets/diagrams/evolution-explanation.png" target="_blank" rel="noopener">
    <img
      ...
      alt="Evolutionary explanation in APS"
      loading="lazy"
    />
  </a>

  <p class="aps-diagram-caption">
    <strong>Evolutionary Explanation in APS.</strong>
