---
date: 2026-09-03
title: "How Did Scientists Learn to Think About Explanation?"
slug: how-did-scientists-learn-to-think-about-explanation
type: article
status: canonical
canonical: true
...
abstract: >
  ...
  development of causal, unificationist, contrastive, interventionist,
  mechanistic, non-causal, and understanding-oriented approaches.
keyPoints:
...
references:
  ...
  - salmon-1990-four-decades-scientific-explanation
...
<div class="aps-diagram">
  <a href="/assets/diagrams/methodology-branched-explanation.png" target="_blank" rel="noopener">
    <img
      src="/assets/diagrams/methodology-branched-explanation.png"
      alt="How the modern debate about scientific explanation branched from earlier concerns through the covering-law model into multiple explanatory approaches."
    />
  </a>
  <p class="diagram-caption">
    <strong>How the modern debate about explanation branched.</strong>
    Different explanatory concerns became increasingly explicit without forming a simple sequence in which each later approach replaced the previous one.
  </p>
</div>
