...
abstract: >
  Viability occupies a central organising position within the APS framework.
  Living systems do not merely survive but actively sustain, regulate, and
  reconstruct the conditions required for continued persistence across changing
  conditions. Agency maintains viability, viability enables organised
  persistence, and organised persistence provides the continuity through which
  living systems exist across time. This article develops viability as the
  organisational condition linking agency, persistence, function, normativity,
  process, scale, development, ecology, and evolution. Within APS, viability is
  understood not as passive survival or static maintenance but as the organised
  capacity to preserve continuity through continual transformation.
...
keyPoints:
  ...
  - Viability is the organisational condition maintained by biological agency.
  - Viability enables organised persistence across changing conditions.
  - Viability is enacted through temporally organised activity.
  - Viability is distributed across biological scales and organisational contexts.
  - Viability is achieved through ongoing organism–world coupling.
  - Viability grounds biological function and normativity.
...
<div class="aps-diagram">
  <a href="/assets/diagrams/viability-continuity.png" target="_blank" rel="noopener">
    <img
      src="/assets/diagrams/viability-continuity.png"
      alt="APS viability architecture showing agency, viability, organised persistence, process, scale, organisation, and organism–world coupling."
      loading="lazy"
    />
  </a>
...
[[box:viability-is-not-mere-survival]]
