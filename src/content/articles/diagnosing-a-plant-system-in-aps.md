...
keyPoints:
  - APS diagnosis can be applied directly to plant systems without invoking nervous systems or representation.
  - Perturbation reveals plant agency through endogenous reorganisation of activity.
  - The Viability Gradient (VG), Normativity Gradient (NG), and Cognitive Integration (CI) provide a structured diagnostic framework.
  - Plant responses demonstrate integrated, viability-oriented organisation across scale.
...
For the definition of NG, see [The Normativity Gradient (NG)](/articles/normativity-gradient/).
...
For the definition of CI, see [Cognitive Integration (CI)](/articles/cognitive-integration/).
