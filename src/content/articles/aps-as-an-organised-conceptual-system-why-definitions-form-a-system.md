...
Key definitions are mutually dependent. Concepts such as agency, process, scale, function, and adaptation are defined in ways that refer to and reinforce one another. Together, they form a network that stabilises the explanatory framework.
...
APS therefore distinguishes between canonical definitions and explanatory development: definitions stabilise the system, while articles allow it to evolve.

Definitions can be extended, clarified, or revised, but such changes must remain consistent with the structure of the system.

---

## Why This Matters

Treating definitions as an organised system has several advantages:

- It prevents conceptual drift  
- It ensures consistency across explanations  
- It allows knowledge to accumulate without ambiguity  
- It makes assumptions explicit rather than implicit  
...
APS shows how scientific frameworks can be organised as systems of mutually constraining concepts, rather than as sets of independently defined terms. This suggests a more general model of theory construction in which coherence is actively maintained rather than assumed.
...
By treating definitions as interdependent constraints within a coherent system, APS maintains conceptual stability while allowing for controlled development over time.

In this way, the framework reflects the very principle it describes: organised persistence through mutually sustaining relations.
