...
keyPoints:
  ...
  - Species and higher taxa can be understood as processual biological individuals.
...
## Species and higher taxa as processual individuals
APS extends this logic across scale. A species, and in some respects higher taxa, can be understood as **processual biological individuals**—not in the sense of bounded objects, but as **coherent, historically continuous organisations**.

This does not collapse distinctions between organism, population, and species. Rather, it situates them within a **multi-scale continuum of individuality**, where organisation persists and transforms across different temporal and spatial extents.
