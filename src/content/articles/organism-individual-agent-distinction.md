...
keyPoints:
  - Organism, individual, and agent describe different aspects of biological unity and must not be conflated.
  - The organism is a dynamically maintained, constraint-closed organisation.
  - The agent is the enactment of viability-oriented activity within that organisation.
  - The individual is a temporally extended continuity of organisation across processes and scales.
  - These are not separate entities but different analytical perspectives on the same organised system.
