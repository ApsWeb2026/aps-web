...
abstract: >
  Biological function and normativity emerge from viability-oriented organised
  persistence. Within APS, functions are not externally assigned purposes or
  merely historically selected effects, but continuity-relevant contributions
  to the organisation through which living systems sustain themselves across
  changing conditions. Normativity arises because organised persistence can
  succeed or fail: some organisational states preserve continuity while
  others undermine it. This article explains how function, normativity,
  evaluation, semiosis, adaptation, malfunction, resilience, and diagnosis
  emerge from temporally organised biological persistence enacted across
  interacting scales and organism–environment systems.

keyPoints:
  - Biological functions are continuity-relevant contributions to organised persistence.
  - Normativity emerges because viable continuity can succeed or fail.
  - Functional organisation is temporally organised, developmental, ecological, and reconstructive.
  - Evaluation operationalises normativity through viability-oriented modulation of activity.
  - Malfunction occurs when organisational relations fail to preserve continuity.
  - Semiosis emerges because differences matter relative to persistence conditions.
  - APS naturalises biological normativity through organised persistence rather than external teleology.
...
> **Where this article fits:** This article develops the APS account of biological function and normativity as emerging from viability-oriented organised persistence. It integrates persistence, agency, evaluation, semiosis, adaptation, malfunction, resilience, and diagnosis within a unified continuity-based explanatory framework.
...
Function identifies how organisational relations contribute to persistence.

Normativity emerges because continuity can succeed or fail.

Living systems therefore generate intrinsic biological significance through the organisation of viable persistence itself.

# Function Beyond Teleology

Biological function has often been interpreted in one of two ways.

Either:
- functions are treated as externally imposed purposes
or:
- functions are reduced entirely to historical evolutionary selection
...
> continuity-relevant contributions to viability-oriented organised persistence.

A process is functional insofar as it contributes to preserving the organisation through which continuity remains viable across changing conditions.

Function therefore emerges from the organisation of persistence itself.
...
Biological organisation becomes normative because organisational states matter differently relative to persistence.
...
Malfunction occurs when organisational relations fail to contribute adequately to continuity.
...
Function consequently provides an important bridge between APS ontology and empirical biological analysis.
...
- and how persistence remains viable across changing conditions

APS therefore naturalises biological significance through viability-oriented organised persistence.

# Conclusion

Biological function identifies continuity-relevant contributions to organised persistence.

Normativity emerges because viability-oriented continuity can succeed or fail across changing conditions.
...
Normativity emerges because organisational continuity must be actively sustained across time.
