...
It is not an introduction to APS, nor a restatement of its core concepts. For an overview, see **[What Is APS?](/orientation/what-is-aps/)**. For the structure of explanation, see **[The Explanatory Geometry of Biology](/articles/explanatory-geometry-of-biology/)**. For the scope of the framework across biological domains, see **[From Life to Explanation](/articles/from-life-to-explanation-emerging-architecture/)**.
...
The primary tool of APS diagnostics is **[perturbation](/glossary/perturbation/)**.
...
A perturbation is informative only insofar as it reveals whether and how the system sustains the conditions required for its continued organisation. This makes **[viability](/glossary/viability/)** the central criterion of biological evaluation.
