...
abstract: >
  ...
  different temporal expressions of the same viability-oriented organised
  persistence. Physiology concerns the real-time regulation of continuity,
  while evolution concerns the historical transformation of continuity across
  generations. APS therefore reconstructs physiology and evolution not as
  separate explanatory domains, but as temporally differentiated perspectives
  on the same continuity-producing biological organisation.
