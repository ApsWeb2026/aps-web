---
date: 2026-09-03
title: "What Makes an Explanation Successful?"
slug: what-makes-an-explanation-successful
type: article
status: canonical
canonical: true
...
role: core
abstract: >
  Scientific explanations can succeed in different ways because they answer
  different questions and identify different kinds of explanatory dependence.
  This article develops a disciplined, target-sensitive account of explanatory
  success based on adequacy to the target, appropriate evidential support,
  explanatory relevance, discrimination, and the conditional contributions of
  mechanism, idealisation, mathematical structure, scope, robustness, and
...
<a href="/assets/diagrams/methodology-explanatory-success.png" target="_blank" rel="noopener">
  <img
    src="/assets/diagrams/methodology-explanatory-success.png"
    alt="Conceptual diagram for assessing explanatory success. A specified explanatory target and claim are assessed through target adequacy, evidential support, explanatory relevance, and discrimination where alternatives compete. Detail and mechanism, abstraction and idealisation, scope and precision, robustness, and scientific understanding are shown as conditional contributors whose importance varies with the explanatory task. The diagram concludes that assessment is disciplined and target-sensitive rather than based on a universal score."
    loading="lazy"
  />
</a>

<p class="aps-diagram-caption">
  <strong>Assessing Explanatory Success.</strong> Explanations remain answerable to their targets, claims, evidence, relevance, and serious alternatives. Other contributions can strengthen an explanation, but their importance varies with the explanatory task and cannot be combined into a universal score.
</p>
