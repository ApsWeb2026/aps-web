...
slug: what-is-a-scientific-explanation
type: article
status: canonical
canonical: true
...
abstract: >
  ...
  This article introduces the explanandum and explanatory target,
  distinguishes explanation from description, prediction, model fit,
  and mere intelligibility, and examines several major forms of
  scientific explanation without reducing them to a single universal
  model.
keyPoints:
  - Scientific explanation begins by specifying what is to be explained.
  - An explanation can be successful for one explanatory target while failing to answer another.
  - Description, prediction, modelling, and understanding are important scientific achievements but are not automatically identical to explanation.
  - Scientific explanations may be causal, mechanistic, unificatory, contrastive, mathematical, structural, or otherwise non-causal.
  - Explanatory plurality does not imply that all explanations are equally adequate.
  - Explanatory adequacy must be assessed relative to the explanandum, evidence, and explanatory work being claimed.
...
<div class="aps-diagram">
  <a
    href="/assets/diagrams/one-phenomenon-different-explanatory-targets.png"
    target="_blank"
    rel="noopener"
  >
    <img
      src="/assets/diagrams/one-phenomenon-different-explanatory-targets.png"
      alt="One biological phenomenon connected to five distinct explanatory targets: causal, mechanistic, mathematical or structural, developmental, and evolutionary or historical questions."
      loading="lazy"
    />
  </a>
  <p class="aps-diagram-caption">
    <strong>One Phenomenon, Different Explanatory Targets.</strong>
    A single biological phenomenon can support several legitimate explanatory questions. Different questions can require different explanatory answers, so comparison is informative only when explanatory targets are sufficiently matched.
  </p>
</div>
