...
The central question is therefore not only how biological systems work, but what kind of organisation must be in place for such explanations to be meaningful.
...
Living systems differ in a crucial respect. Their organisation is such that the processes they enact contribute to the maintenance of the conditions that allow those processes to continue.
...
A fully biological explanation must therefore do more than specify mechanisms. It must account for the organisation that makes those mechanisms part of a living system.
...
Once viability-oriented organisation is recognised, further features of biological systems become intelligible.
...
Some states support persistence; others undermine it. This distinction is not imposed from outside but arises within the organisation of the system itself.
...
Short-term regulation and long-term evolution are not separate domains. They are different temporal expressions of the same viability-oriented organisation.
...
- how this organisation is sustained across scales and over time  
...
The APS framework identifies viability-oriented, constraint-closed organisation as the defining feature of such systems. Biological explanation is therefore the explanation of how this organisation is established, maintained, and transformed.

By clarifying what needs to be explained, APS provides a unified explanatory grammar for understanding life.
