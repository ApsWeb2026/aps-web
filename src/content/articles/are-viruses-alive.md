...
abstract: >
  Viruses occupy one of the most debated boundary regions in biology. They
  evolve, inherit, adapt, and undergo natural selection, yet they do not
  exhibit the autonomous viability-oriented organisation characteristic of
  living systems. This article uses viruses as a test case for the APS
  definition of life, showing why participation in biological processes is
  not sufficient for biological organisation.

keyPoints:
  - Viruses participate in evolution, inheritance, adaptation, and natural selection.
  - Participation in biological processes is not the same as constituting a living system.
  - APS defines life through viability-oriented, constraint-closed organisation.
  - Viruses do not independently maintain their own viability or organised persistence.
  - Viral boundary cases help clarify what distinguishes living systems from non-living biological entities.
...
[[box:participation-is-not-organisation]]
...
<div class="aps-diagram">
  ...
  <p class="aps-diagram-caption">
    ...
    Viruses participate in many biological processes associated with life, including inheritance, variation, evolution, and natural selection. APS argues that participation alone is insufficient for life. Living systems are distinguished by viability-oriented organisation, constraint closure, self-maintenance, and agency.
  </p>
</div>
