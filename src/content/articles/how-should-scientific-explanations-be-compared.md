---
date: 2026-09-04
title: "How Should Scientific Explanations Be Compared?"
slug: how-should-scientific-explanations-be-compared
type: article
status: canonical
canonical: true
...
abstract: >
  Scientific explanations can be compared fairly only when their
  explanatory targets are sufficiently matched, their strongest serious
  alternatives are reconstructed, and their relationship is classified
  before any judgment of preference or explanatory gain.

keyPoints:
  - Comparing explanations is not identical to choosing between entire theories or frameworks.
  - A fair comparison must lock the explanandum, contrast, grain and explanatory aim.
  - Candidate accounts may be rival, complementary, partially overlapping, target-different, non-comparable or unresolved.
  - Comparative difference does not by itself establish explanatory gain.
...
references:
  ...
  - weisberg-2013-simulation-similarity
  ...
  - nakajima-et-al-2005-reconstitution-circadian-oscillation
  - trivers-willard-1973-natural-selection-parental-ability
---
...
<a href="/assets/diagrams/methodology-comparison.png" target="_blank" rel="noopener">
  <img
    src="/assets/diagrams/methodology-comparison.png"
...
<p class="aps-diagram-caption">
  <strong>Comparing Scientific Explanations.</strong>
  Fair comparison requires a locked explanatory target, strongest-alternative reconstruction and relation classification before ranking. Rivalry is only one possible outcome, and comparative difference does not by itself establish explanatory gain.
</p>
...
Related articles: [What Makes an Explanation Successful?](/articles/what-makes-an-explanation-successful/) and [How Do Scientific Explanations Go Wrong?](/articles/how-do-scientific-explanations-go-wrong/).
