...
keyPoints:
  - The Viability Gradient (VG) expresses how effectively a system sustains its own persistence under perturbation.
  - VG replaces binary classifications (alive/not alive) with a continuous diagnostic scale.
  - High VG systems actively restore viable conditions through endogenous reorganisation.
  - Low VG systems are fragile, dependent, or unable to recover from disruption.
  - VG must be assessed across time and scale, not at a single moment.
...
For the role of organism–environment relations in this process, see [Organism–World Coupling — Why Agency Is Not Control](/articles/organism-world-coupling-agency-not-control/).
...
For the full method, see [How to Diagnose a Biological System (APS Method)](/articles/how-to-diagnose-a-biological-system/).
