---
date: 2026-09-04
title: How Do Scientific Explanations Go Wrong?
slug: how-do-scientific-explanations-go-wrong
type: article
status: canonical
canonical: true
...
role: core
abstract: >-
  Scientific explanations can go wrong in different ways. They may compare
  accounts that answer different questions, claim causation from insufficient
  evidence, overstate model validation, generalise beyond an established
  domain, conceal exploratory flexibility, substitute narrative coherence for
  evidential discrimination, or present integration as demonstrated
  explanatory advance. This article distinguishes these failures and shows why
  correction should be calibrated to the particular defect rather than treated
  as wholesale scientific rejection.
keyPoints:
...
references:
  ...
  - gould-lewontin-1979-spandrels
  - rossouw-et-al-2002-estrogen-progestin-whi
  - hernan-et-al-2008-observational-studies-randomized-experiments
---
...
<p class="aps-diagram-caption">
  <strong>Diagnostic Map of Explanatory Overclaim.</strong>
  Scientific explanations can exceed their warrant in different ways. The appropriate response depends on the particular mismatch between target, claim and evidence; identifying an overclaim does not automatically eliminate the contribution that remains supported.
</p>
...
Related glossary terms include [biological explanation](/glossary/biological-explanation/), [explanation](/glossary/explanation/), [explanandum](/glossary/explanandum/), [explanatory target](/glossary/explanatory-target/) and [mechanism](/glossary/mechanism/).
