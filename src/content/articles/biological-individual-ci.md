...
abstract: >
  ...
  individuals from species and taxa, and situates individuation within a processual,
  multi-scale account of life.
keyPoints:
  - A biological individual is a unit of viability-oriented, constraint-closed organisation.
  - Individuals are loci of biological agency and the primary bearers of persistence.
  - Individuality is defined by organisation, not by morphology, genetics, or boundaries alone.
  - Biological individuals are distinct from species and taxa, which track patterns across individuals.
  - APS distinguishes between biological individuals (units) and processual individuals (continuities across time).
