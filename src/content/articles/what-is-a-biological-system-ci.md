---
date: 2026-07-27
title: What Is a Biological System? — Mechanisms, Agency, and Organised Persistence
...
abstract: >
  Biological systems are commonly described in terms of their components,
  mechanisms, or characteristic properties, yet these descriptions do not by
  themselves explain what makes a system biological. This article argues that
  biological systems are distinguished not simply by the mechanisms they
  contain but by viability-oriented, constraint-closed organisation through
  which they actively maintain and re-establish the conditions of their own
  organised persistence. Drawing on the Agency–Process–Scale (APS)
  framework, the article shows how mechanisms, regulation, repair, organisms,
  process, and scale become scientifically intelligible when understood as
  aspects of a single organisational reality. It therefore provides an
  integrated public explanation of what distinguishes biological systems from
  other organised physical systems.

keyPoints:
  - A system is not biological simply because it is complex, organised, or regulated.
  - Biological traits and mechanisms describe living systems but do not by themselves explain what makes them biological.
  - Life is viability-oriented, constraint-closed organisation.
  - Biological systems actively maintain and re-establish the conditions of their own organised persistence.
  - Biological Agency is the viability-oriented organisational activity through which this organisation is enacted.
  - Process explains how organised persistence is maintained through continual change.
  - Scale explains where organised persistence is organised across spatial and temporal extents.
  - Agency, Process, and Scale are analytic projections of one living organisation.
