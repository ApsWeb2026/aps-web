...
abstract: >
  This article revisits the question of what life is, arguing that life is best understood as viability-oriented, constraint-closed organisation sustained through organised persistence. Rather than defining life through a list of traits, APS treats life as a distinctive form of organisation that maintains the conditions of its own continued existence across changing circumstances.

keyPoints:
  - Life is not defined by a fixed list of properties but by viability-oriented organised persistence.
  - APS understands life as viability-oriented, constraint-closed organisation.
  - The question of life requires an explanatory framework rather than a classificatory checklist.
...
<div class="aps-diagram">
  <a href="/assets/diagrams/what-is-life.png" target="_blank" rel="noopener">
    <img
      ...
      alt="APS diagram showing life as viability-oriented, constraint-closed organisation sustained through organised persistence"
      loading="lazy"
    />
  </a>

  <p class="aps-diagram-caption">
    <strong>What Makes Something Alive?</strong>
    APS defines life as viability-oriented, constraint-closed organisation sustained through organised persistence. Agency is the activity through which living systems maintain viability, while process and scale describe how persistence is organised through time and across biological organisation.
  </p>
</div>
