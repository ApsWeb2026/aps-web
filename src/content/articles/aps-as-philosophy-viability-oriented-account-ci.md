...
> **Where This Article Fits:** This article presents APS as a philosophical perspective grounded in its biological account of life. Building upon What Is APS?, How APS Explains Life, Understanding APS, and APS as a Viability-Oriented Framework, it asks what follows when the explanatory principles developed within biology are considered more broadly. Rather than introducing the biological architecture of APS, the article explores its implications for questions concerning reality, knowledge, explanation, meaning, value, and humanity's place within the natural world. Readers seeking APS's philosophy of biology should consult The Philosophical Foundations of APS, which develops the framework's account of life, agency, organised persistence, and biological explanation. Together, the two articles serve complementary purposes: The Philosophical Foundations of APS articulates the philosophical commitments underlying APS's account of life and biological explanation, while APS as Philosophy explores the wider philosophical implications of that framework.

## Philosophy Through Biology
