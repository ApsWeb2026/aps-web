...
keyPoints:
  - Natural selection operates on differences in the capacity of systems to sustain viability-oriented organisation.
  - Selection presupposes the existence of systems capable of organised persistence.
  - What is selected is not a component but a pattern of organisation.
  - Genes participate in selection but are not its primary objects.
  - Selection filters variation; it does not generate organisation or agency.
  - Evolutionary explanation requires distinguishing between the conditions of persistence and the processes that act within those conditions.
