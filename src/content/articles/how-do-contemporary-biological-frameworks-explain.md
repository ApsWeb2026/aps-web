---
date: 2026-09-04
title: "How Do Contemporary Biological Frameworks Explain?"
slug: how-do-contemporary-biological-frameworks-explain
type: article
status: canonical
canonical: true
...
abstract: >
  Contemporary biology uses multiple explanatory approaches, including
  mechanistic, evolutionary, developmental, systems, organisational and formal
  frameworks. These approaches do not all address the same explanatory targets
  or carry the same explanatory burdens. This article reconstructs a
  representative landscape of contemporary biological explanation and shows why
  frameworks should be understood by what they explain and how they explain it
  before their relative merits are compared.

eyPoints:
  - "Contemporary biological explanation is plural: different approaches can address different aspects of a biological target."
  - "Mechanistic, evolutionary, developmental, systems, organisational and formal approaches characteristically bring different explanatory resources."
  - "A framework label does not by itself determine the explanatory content of a particular scientific account."
  - "Frameworks can overlap in evidence, concepts or explanatory resources without becoming identical."
  - "Explanatory vocabularies such as function, information or control should not automatically be treated as separate peer frameworks."
  - "Frameworks should be reconstructed in relation to a specified explanandum before their explanatory contributions are compared or ranked."
...
references:
  ...
  - kitano-2002-computational-systems-biology
  - kitano-2004-biological-robustness
  - gilbert-2000-diachronic-biology-evo-devo
  - love-2014-erotetic-organization-developmental-biology
  - laland-et-al-2015-extended-synthesis
...
<a href="/assets/diagrams/methodology-explanatory-landscape.png" target="_blank" rel="noopener">
  <img
    src="/assets/diagrams/methodology-explanatory-landscape.png"
    alt="Representative landscape showing a specified biological explanandum surrounded by mechanistic explanation, evolutionary explanation, evolutionary developmental biology, niche construction, the Extended Evolutionary Synthesis, systems biology, organisational autonomy, and the Free Energy Principle and active inference, presented without hierarchical or comparative ranking."
    loading="lazy"
  />
</a>

<p class="aps-diagram-caption">
  <strong>Representative Explanatory Landscape.</strong>
  Contemporary biological explanation draws on multiple, sometimes overlapping approaches whose relevance depends on the explanandum and explanatory task. The approaches shown are representative rather than exhaustive, and their arrangement does not imply explanatory ranking.
</p>
...
Relevant glossary entries include [Biological Explanation](/glossary/biological-explanation/), [Explanation](/glossary/explanation/), [Explanandum](/glossary/explanandum/) and [Explanatory Target](/glossary/explanatory-target/).

The preceding article, [What Counts as Explanatory Gain?](/articles/what-counts-as-explanatory-gain/), established what must be shown before a controlled explanatory difference can count as bounded gain.
