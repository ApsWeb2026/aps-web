...
abstract: >
  ...
  degree rather than kind. APS rejects this conclusion. This article argues
  that behavioural sophistication alone is insufficient for biological agency.
  Biological agency depends upon viability-oriented, self-maintaining
  organisation sustained across time, whereas contemporary AI systems remain
  externally maintained optimisation systems lacking endogenous persistence
  and constraint-maintaining organisation.
...
This does not mean that artificial systems are uninteresting, unintelligent, or incapable of sophisticated behaviour. Nor does APS deny that biological systems may inspire artificial architectures. Instead APS argues that behavioural sophistication alone is insufficient for biological agency.
...
An AI system may optimise effectively within a designated problem space while possessing no intrinsic relation to its own persistence as an organised system. Its optimisation processes do not primarily function to maintain the system’s own viability. Instead they function to satisfy externally specified objectives.
...
The distinction is especially important because biological normativity emerges from these viability conditions. Biological processes succeed or fail relative to the persistence of the organised system.
...
Many such systems exhibit organisational features inspired by biology. Yet inspiration is not equivalence.
...
Artificial systems may increasingly resemble organisms behaviourally. But biological agency depends not simply upon what systems do, but upon how they persist as organised systems in the first place.
