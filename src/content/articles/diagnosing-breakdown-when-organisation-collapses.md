...
keyPoints:
  - APS distinguishes local malfunction from global organisational collapse.
  - Breakdown occurs when viability-oriented organisation can no longer be sustained.
  - Constraint closure may persist temporarily even as viability fails.
  - Loss of endogenous reorganisation marks the transition from system to non-system.
  - VG, NG, and CI all degrade in characteristic ways during collapse.
