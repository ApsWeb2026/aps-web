---
date: 2026-09-05
title: Which Explanatory Framework Is Best?
slug: which-explanatory-framework-is-best
type: article
status: canonical
canonical: true
...
role: core
abstract: Biological explanatory frameworks cannot be ranked globally without first specifying what is being explained and what the relevant alternatives are. This article shows how controlled, target-relative comparison can support bounded explanatory gain, complementarity, no additional gain, unresolved assessment or non-comparability without turning local results into a universal league table.
keyPoints:
  - "Frameworks should be compared for specified explanatory targets, not ranked globally."
  - "A local explanatory advantage does not establish framework-wide superiority."
  - "Explanatory difference, usefulness, integration or formal sophistication does not by itself establish explanatory gain."
  - "Controlled comparison can support bounded positive gain, complementarity, no additional gain, unresolved assessment or non-comparability."
  - "The strongest relevant comparator must receive full explanatory credit before additional explanatory capacity is claimed."
...
references:
  ...
  - chan-et-al-2010-stickleback-pitx1-enhancer
  - laland-matthews-feldman-2016-niche-construction-theory
  - bich-mossio-soto-2020-glycemia-regulation
  - pezzulo-rigoli-friston-2015-active-inference-homeostatic-regulation
  - raja-et-al-2021-markov-blanket-trick
---

**Where This Article Fits**

*The preceding article, [How Do Contemporary Biological Frameworks Explain?](/articles/how-do-contemporary-biological-frameworks-explain/), reconstructed representative explanatory frameworks by asking what they explain, what resources they use and what explanatory burdens they carry. It deliberately did not rank them.*

*Before that, [What Counts as Explanatory Gain?](/articles/what-counts-as-explanatory-gain/) established a stricter criterion: explanatory gain is a bounded, target-relative and comparator-relative conclusion requiring evidence of additional explanatory capacity relative to a sufficiently strong alternative.*
...
<table>
  <tbody>
    <tr>
      <td>
        <strong>No League Table</strong><br><br>
...
<a href="/assets/diagrams/methodology-best-framework.png" target="_blank" rel="noopener">
  <img
    src="/assets/diagrams/methodology-best-framework.png"
    alt="Controlled framework-comparison diagram showing a specified explanandum and strongest relevant comparator leading through controlled comparison to five non-ranked possible outcomes: bounded positive gain, complementarity or bidirectional contribution, no additional gain, unresolved, and non-comparability."
    loading="lazy"
  />
</a>

<p class="aps-diagram-caption">
  <strong>Controlled Outcomes of Framework Comparison.</strong>
  Once a specified explanandum and sufficiently strong relevant comparator have been established, controlled comparison can support different bounded verdicts. The outcomes are alternatives rather than ranks, and none by itself establishes framework-wide superiority or inferiority.
</p>
...
<table>
  <tbody>
    <tr>
      <td>
        <strong>Complementarity Is Not Compromise</strong><br><br>
...
Relevant glossary terms include [Biological Explanation](/glossary/biological-explanation/), [Explanation](/glossary/explanation/), [Explanandum](/glossary/explanandum/) and [Explanatory Target](/glossary/explanatory-target/).

The immediate methodological predecessors are [What Counts as Explanatory Gain?](/articles/what-counts-as-explanatory-gain/) and [How Do Contemporary Biological Frameworks Explain?](/articles/how-do-contemporary-biological-frameworks-explain/).
